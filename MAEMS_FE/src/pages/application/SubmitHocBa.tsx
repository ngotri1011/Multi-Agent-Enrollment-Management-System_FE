...
const REQUIRED_DOCS = [
  ...
  "Bản photo/scan Học bạ THPT (đầy đủ 6 học kỳ)",
  "Chứng nhận xếp hạng học sinh THPT năm 2025 (SchoolRank.fpt.edu.vn)",
];
          ...
          <>
            ...
            <div className="rounded-2xl bg-white border border-gray-100 shadow-sm p-6 md:p-8">
              <Form form={form} layout="vertical" onFinish={handleSubmit} requiredMark={false}>
                {/* Applicant info (read-only from profile) */}
                {applicant ? (
                ...
                <Text className="text-gray-400 text-xs mb-4 block">
                  Tick vào từng mục để xác nhận bạn đã chuẩn bị đầy đủ. Nộp bản mềm (PDF/JPG/PNG) tại email tuyển sinh sau khi đăng ký.
                </Text>
