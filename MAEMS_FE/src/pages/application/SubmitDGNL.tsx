...
const DOC_FIELDS: DocField[] = [
  ...
  {
    id: "ket_qua_dgnl",
    label: "Bản sao Giấy chứng nhận kết quả thi ĐGNL của ĐHQG Hà Nội hoặc ĐHQG TP.HCM năm 2026",
    required: true,
    accept: "image/*,.pdf",
  },
  {
...
export function SubmitDGNL() {
  ...
  async function handleSubmit(values: FormValues) {
    ...
    try {
      ...
      messageApi.success("Đăng ký xét tuyển theo ĐGNL thành công!");
